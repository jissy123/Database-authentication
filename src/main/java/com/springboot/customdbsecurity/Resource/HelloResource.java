...
public class HelloResource {
    ...
    //localhost:8080/rest/hello/secured/admin -> It will be access only for user who is having ADMIN Role
  ...
  //localhost:8080/rest/hello/secured/guest -> It will be access only for user who is having ADMIN or GUEST Role
    @PreAuthorize("hasAnyRole('GUEST','ADMIN')")
    @GetMapping("/secured/guest")
